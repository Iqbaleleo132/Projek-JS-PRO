            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <p class="lead">Biji kopi yang dipilih untuk membuat NESCAFÉ Classic nggak sembarangan. Kandungannya terbuat dari 100% kopi Robusta murni yang ditanam dan dipanen secara langsung oleh para petani di wilayah perkebunan kopi yang berkualitas</p>
                        <div class="d-flex">
